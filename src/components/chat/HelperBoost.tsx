              ...
              >
                {questionConfig.map(({ key, color, icon: Icon }) => (
                  <Button
                    ...
                    variant="outline"
                    className="border-border hover:bg-border/30 h-auto min-w-[110px] flex-shrink-0 cursor-pointer rounded-xl border bg-white/80 px-4 py-3 shadow-none backdrop-blur-sm transition-none active:scale-95"
                  >
